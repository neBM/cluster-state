...
resource "nomad_csi_volume_registration" "nfs_volume" {
  ...
  plugin_id   = "nfs"
  name        = "martinibar_prod_forgejo_jenkins"
  volume_id   = "martinibar_prod_forgejo_jenkins"
  external_id = "martinibar_prod_forgejo_jenkins"
  ...
  context = {
    ...
    "share"  = "/volume1/csi/forgejo/jenkins",
  }
}
